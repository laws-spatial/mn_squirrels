...
filenames = glob.glob("./data/*forest_inventory_species.shp")
filenames.extend(glob.glob("./data/*management_units.shp"))
filenames.extend(glob.glob("./data/*landcover*.shp"))
